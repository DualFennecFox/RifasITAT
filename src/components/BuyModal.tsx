...
export default function BuyModal({ toggleModal, dollar, available }: {
    ...
    return (
        <div style={{ alignItems: !isOverflowing || showRoulette ? "center" : "initial" }} ref={elementRef} className="absolute sm:fixed overflow-auto top-0 left-0 size-full bg-black bg-opacity-50 sm:flex sm:flex-row justify-center">
                {showRoulette ? <RoulettePage winningNumbers={winningNumbers} setWinningNumbers={setWinningNumbers} rouletteCallback={rouletteCallback} />
                    : <div className="bg-gray-700 h-max sm:rounded-2xl">
                        ...
                        <div>
                            <div className="w-full pb-5 sm:pb-0 flex imtes-center justify-center">
                            ...
                            <div className="flex w-full flex-col sm:flex-row items-center justify-center">
                                <div className="w-1/2 sm:pl-10 flex flex-col items-center justify-center gap-2">
                                    <div className="p-0.5 text-lg flex items-center justify-center rounded-2xl bg-gradient-to-r from-[#D68A4E] from-40% to-[#FAE6A9]">
                                        <div className="flex flex-col text-nowrap gap-1 rounded-2xl bg-black p-5 text-white">
                                            <h1
                            ...
                            <p className="mt-3 text-center text-mg/6 text-gray-400">
